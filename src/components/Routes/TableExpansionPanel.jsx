...
const TableExpansionPanel = ({ rowData, scroll, redirectView, myDivToFocus }) => {
      ...
      <>
        <div style={{ width: '5%', float: 'left', margin: '25px 0', textAlign: 'center' }}>
          <div style={{ display: 'inline-block' }} onClick={() => scroll(-12000, rowData)}>
            <img alt="icon" src={arrow} className={classes._fontsize12} style={{ transform: 'rotate(180deg)' }} />
            <img alt="icon" src={arrow} className={classes._fontsize12} style={{ transform: 'rotate(180deg)' }} />
          </div>
          <img alt="icon" src={arrow} onClick={() => scroll(-100, rowData)} className={classes._fontsize12} style={{ marginLeft: '15px', transform: 'rotate(180deg)' }} />
        </div>
        <div style={{ width: '5%', float: 'right', margin: '25px 0', textAlign: 'center' }}>
          <img alt="icon" style={{ marginRight: '15px', }} src={arrow} onClick={() => scroll(12000, rowData)} className={classes._fontsize12} />
