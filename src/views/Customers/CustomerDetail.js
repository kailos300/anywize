...
const CustomerDetail = () => {
  ...
  return (
    <div className={classes._container}>
      ...
      <div className={classes._basicdetailhead}>
        <div>
          <Typography className={clsx(classes._head, classes._width11)} variant="h6">{t('Street')}</Typography>
          <Typography className={clsx(classes._detail, classes._width11)} variant="h6">{customer.street}</Typography>
        </div>
        <div>
          <Typography className={clsx(classes._head, classes._name)} variant="h6">{t('House No.')}</Typography>
          <Typography className={clsx(classes._name, classes._detail)} variant="h6">{customer.street_number}</Typography>
        </div>
        <div>
          <Typography className={classes._head} variant="h6">{t('Zipcode')}</Typography>
          <Typography className={classes._detail} variant="h6">{customer.zipcode}</Typography>
        </div>
        <div>
          <Typography className={classes._head} variant="h6">{t('City')}</Typography>
          <Typography className={classes._detail} variant="h6">{customer.city}</Typography>
        </div>
        <div>
          <Typography className={classes._head} variant="h6">{t('Country')}</Typography>
          <Typography className={classes._detail} variant="h6">{customer.country}</Typography>
        </div>
        <div>
          <Typography className={classes._head} variant="h6">{t('Geolocation')}</Typography>
          <Typography className={classes._detail} variant="h6">{customer.latitude}, {customer.longitude}</Typography>
        </div>

      </div>
      {/** */}
      <Typography className={clsx(classes._infoheading, classes._margintop80)} variant="h5">{t('Contact')}</Typography>
      <div className={classes._basicdetailhead}>
        <div>
      ...
      <div className={classes._basicdetailhead}>
        <div>
          ...
          <Typography className={clsx(classes._detail)} variant="h6">{customer.phone || '–'}</Typography>
      ...
      <div className={classes._basicdetailhead}>
        <div>
          ...
          <Typography className={clsx(classes._detail)} variant="h6">{DEPOSIT_AGREEMENTS[customer.deposit_agreement]}</Typography>
        </div>
        {
